...
public class focusing : MonoBehaviour
{
    ...
    IEnumerator Focus()
    {
        while (true)
        {
            ...
            {
                _camera.GetComponent<cameraMovement>().Player.GetComponent<Movement>().enabled = false;
            ...
            _camera.GetComponent<cameraMovement>().Player.GetComponent<Movement>().enabled = true;
